...
# import resources2html
# resources2html.resources2html('../CCWJ_Website.xlsx')
...
def resources2html(excel_path):
    # read sheet named researchin excel file
    data = pd.read_excel(excel_path, sheet_name="Resources_Intro")
    ...
    print('resources2html complete')


def write_section(section_name, data, index_start):
    print('resources: writing ' + section_name)
    ...
    for i, row in data.iloc[index_start:].iterrows():
        ...
        for header, value in row.items():
            ...
            # insert html for special sections
            ...
            if header.startswith('Section_Heading') and value:
                ...
                img_folder = os.path.join('../Assets/Resources/', section_name.replace(' ', '_'))
                img_path = ''
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse pt-2" id="navbarCollapse">
              <div class="navbar-nav ms-auto me-4">
                  ...
                  <a class="nav-link active" aria-current="page" href="../Resources/resources.html">Resources</a>
