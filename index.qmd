...
```{=html}
<style>
/* Homepage conference announcement bar */
.hlbw-banner{
  max-width: 1100px;
...
@media (max-width: 700px){
  .hlbw-banner{flex-direction:column; align-items:stretch;}
  .hlbw-banner img{width:100%; height:140px;}
  .hlbw-banner .actions{justify-content:flex-start;}
}
</style>
