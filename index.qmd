...
/* Register = filled dark gradient + white border + white text */
.hlbw-register{
  background: linear-gradient(180deg, #2b333b 0%, #1b232b 100%);
...
.hlbw-register:hover{
  background: linear-gradient(180deg, #313b44 0%, #1f2831 100%);
}

/* More Info = transparent + white border + white text */
.hlbw-more{
