...
/* tighter bottom = no extra space under buttons */
.hlbw-content{
  padding: 14px 14px 10px 14px;  /* <-- smaller bottom padding */
  color:#fff;
}
...
.hlbw-meta{
  font-size:0.82rem;
  opacity:0.82;
  margin:0 0 10px 0;  /* <-- less space before buttons */
}

.hlbw-actions{
  display:flex;
  gap:10px;
  margin:0;           /* <-- prevents any bottom gap */
}
...
.hlbw-btn{
  ...
  font-weight:800;
  text-decoration:none;
  border:1px solid #ffffff;     /* <-- white border for BOTH */
  color:#ffffff;                 /* <-- white text for BOTH */
}

/* filled button with CCWJ-like dark gradient */
.hlbw-register{
  background: linear-gradient(180deg, #2b333b 0%, #1b232b 100%);
}
