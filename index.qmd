...
/* Show the whole poster (no cropping) */
#hlbw-popup img {
  width: 100%;
  height: auto;
  display: block;
...
<div id="hlbw-popup" role="dialog" aria-label="International Conference on Handheld Laser Beam Welding 2026">
  <button class="close" aria-label="Close" id="hlbw-popup-close">×</button>

  <a href="https://www.ccwjannualseminar.ca/" aria-label="Conference website">
    <img src="assets/HLBW%20Conf.jpg" alt="International Conference on Handheld Laser Beam Welding 2026 poster">
  </a>
...
(function () {
  ...
  // Always show on homepage load (even after closing), with a small delay
  popup.style.display = 'none';
  setTimeout(() => {
    popup.style.display = 'block';
  }, 1200);

  // Close only hides it for this page view; refresh will show it again
